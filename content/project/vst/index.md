---
title: "Robot-assisted Gait Rehabilitation using the Variable Stiffness Treadmill"
summary: "Investigating sensorimotor mechanisms of inter-leg coordination via Variable Stiffness Treadmills (VST/VST 2) to advance targeted robotic gait rehabilitation for the mobility impaired."
type: book
weight: 2
# Disable author profile block
profile: false
authors: []
share: false
show_date: false
...
<div style="display: flex; flex-direction: column; gap: 2rem; margin: 2rem 0; width: 100%;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
  <img src="./vst-exp-1.jpg" alt="Experimental Setup" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">
  <img src="./vst-exp-2.jpg" alt="Neural Control Interface" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">
</div>
