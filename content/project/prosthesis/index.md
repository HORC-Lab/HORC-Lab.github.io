---
title: "Advanced Controllers for Lower-limb Prostheses Enhancing Agility"
summary: "Developing advanced control systems for lower-limb prostheses that integrate real-time sensory feedback and biomechanics to enhance stability, agility, and user adaptation."
type: book
weight: 3
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 1rem; margin-bottom: 2rem;">
  <img src="./prosthesis-exp-1.jpg" alt="Experimental Setup" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">
  <img src="./prosthesis-exp-2.jpg" alt="Neural Control Interface" style="width: 100%; height: 300px; object-fit: cover; border-radius: 8px;">
</div>
